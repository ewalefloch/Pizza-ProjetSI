...
const Profil = ({ userId, estClient }) => {
  ...
  const [showCommande, seSthowCommande] = useState(false);
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:ml-6 text-center md:text-left">
              <h1 className="text-2xl font-bold text-white ">
                {userInfo?.nom || (userId ? "Utilisateur" : "Invité")}
              </h1>
          ...
          {!userId ? (
            ...
            <div className="bg-amber-50 p-8 rounded-md text-center">
              ...
              <p className="text-amber-700 mb-6">
                Veuillez vous connecter pour accéder à votre profil et gérer vos
            ...
            <div>
                ...
                <div className="bg-amber-50 p-4 rounded-md">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="font-medium">
                        {userInfo?.adresseEmail || "Non spécifié"}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-amber-50 p-4 rounded-md">
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-col">
                      ...
                      <span className="font-medium">
                        {userInfo?.adressePostale || "Non spécifiée"}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-6 flex">
                <button className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-md flex items-center" onClick={() => seSthowCommande(true)}>
                  Voir mes commandes
                </button>
              </div>
