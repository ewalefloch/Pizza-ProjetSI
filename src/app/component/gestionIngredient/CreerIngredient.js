...
const CreerIngredient = ({ ajouterIngredient, fermer }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!nom || !prix || !description) {
      setMessage({
        type: "error",
        text: "Nom, prix et description sont obligatoires !",
      });
      return;
    }
    ...
    try {
      ...
      // Création de l'objet ingrédient à encoder en JSON
      ...
      // Ajout de l'ingrédient encodé en JSON dans FormData
  ...
  return (
    ...
    >
      <div className="bg-white p-6 rounded-lg shadow-lg w-auto max-w-2xl max-h-[90vh] overflow-y-auto">
